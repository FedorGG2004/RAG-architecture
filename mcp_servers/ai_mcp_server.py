    ...
    def setup_routes(self):
        ...
        async def rag_query(request: RAGRequest):
            ...
            try:
                ...
                # 2. Формирование промпта (ЕДИНЫЙ ПРОМПТ)
...
3. Если информации в контексте НЕТ, честно скажи "Я не нашел информации по этому вопросу в базе знаний"
4. Будь точным и конкретным
5. Не добавляй информацию, которой нет в контексте
6. Формулируй ответ полными предложениями
...
СФОРМУЛИРУЙ ОТВЕТ, СООТВЕТСТВУЮЩИЙ ИНСТРУКЦИЯМ ВЫШЕ:
